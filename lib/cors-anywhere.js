...
function withCORS(headers, request) {
  ...
  if (request.url.charAt(0) === '/') {
    ...
    request_url = request.url.substring(1);
  }
  ...
  if (request_url != null) {
   // Create a URL object
    var url = new ModUrl(request_url);
    // Get the value of the "referrer" parameter
    var referrerValue = url.searchParams.get('referrer');
    if (referrerValue != null) {
      headers['Origin'] = referrerValue;
    } 
  }
